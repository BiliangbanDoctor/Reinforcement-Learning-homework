...
class PolicyGradient(object):
    ...
    def save_model(self, file_path='./model/Maze-v0-PG.h5'):
        print ('Model saved')
...
env.seed(1)
env = env.unwrapped
DISPLAY_REWARD_THRESHOLD = -120  # renders environment if total episode reward is greater then this threshold
